            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="header slideDown">
                        <div class="logo"><img src="/assets/images/logon.png" alt=""></div>
                   </div>                        
                </div>

                <% If ErrorText <> "" Then %>
                <div class="alert bg-blue w-100"><i class="material-icons" style="vertical-align: middle;">error</i> <%=ErrorText%></div>
                <% ErrorText=""%>
                <% End If %>

				<% If Session("Error") <> "" Then %>
                    <div class="alert bg-blue w-100"><i class="material-icons" style="vertical-align: middle;">error</i> <%=Session("Error")%></div>
                    <div class="c10"></div>
                    <% Session("Error") = "" %>
                <% End If %>
                        
                <% If Session("Ok") <> "" Then %>
                    <div class="alert bg-blue w-100"> <i class="material-icons" style="vertical-align: middle;">check_circle</i> <%=Session("Ok")%></div>
                    <div class="c10"></div>
                    <% Session("Ok") = "" %>
                <% End If %>

                <form class="col-lg-12" id="sign_in" method="POST" action="/login/"  onsubmit="return Login();">
                    <h5 class="title">Hoşgeldiniz<br>Giriş Yapınız</h5>
                    <div class="c20"></div>
